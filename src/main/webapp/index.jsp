                            ...
                            <div class="card-columns">
                                ...
                                <div class="card product-card">
                                    ...
                                    <div class="card-footer text-center">
                                       <button class="btn custom-bg text-white" onclick="deleteItemFromCart(<%= p.getpId()%>, '<%= p.getpName()%>',<%= p.getPriceAfterApplyingDiscount()%>)">-</button>
                                        ...
                                        <button class="btn custom-bg text-white" onclick="add_to_cart(<%= p.getpId()%>, '<%= p.getpName()%>',<%= p.getPriceAfterApplyingDiscount()%>)">+</button>
